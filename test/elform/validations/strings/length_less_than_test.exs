defmodule Elform.Validations.Strings.LengthLessThanTest do
  use ExUnit.Case
  use Elform
  ...
  describe "when the first argument is a SchemaFieldError struct" do
    test "then return a SchemaFieldError" do
      ...
      response =
        %{field: length_less_than(error, @required_length)}
        |> Elform.parse_errors()
  ...
  describe "when the second argument is not a number" do
    test "then return a SchemaFieldError" do
      ...
      response =
        %{field: length_less_than(value, nil)}
        |> Elform.parse_errors()
  ...
  describe "when the first argument is not a string" do
    test "then return a SchemaFieldError" do
      ...
      response =
        %{field: length_less_than(value, @required_length)}
        |> Elform.parse_errors()
  ...
  describe "when the text length is greater than #{@required_length}" do
    test "then return a SchemaFieldError" do
      ...
      expected_response = %{field: "the value must be less than #{@required_length}"}
