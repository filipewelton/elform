defmodule Elform.Validations.Map.MapEquality do
  @behaviour Elform.Validations.Behaviour

  use Elform.Utilities.ActionFallback, name: :map_equality, type: :map
  ...
  def call(value, args) do
    ...
    case k1 === k2 and v1 === v2 do
      true -> :ok
      false -> [map_equality: "the map must be equal to {#{parsed_map}}"]
    end
  end
